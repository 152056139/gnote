...
namespace ConsoleApplication1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //查询sql
            String sqlSearch = "select * from notebook";
            //插入sql
        ...
        {
            String mysqlStr = "Database=gnote;Data Source=127.0.0.1;User Id=root;Password=root;pooling=false;CharSet=utf8;port=3306";
