...
namespace System.Windows.Forms
{
    public class RichTextBoxCtrl : RichTextBox
    {
        ...
        {
            ViewRtfSoruceDlg rtfdlg = new ViewRtfSoruceDlg();

            string s = string.Format("文件很大 请等待... {0}KB", (richTextBox1.Rtf.Length /1204));
         
            //if (richTextBox1.Rtf.Length > 1024*1024)
            //    MessageBox.Show(s);

            rtfdlg.textBox1.Text = richTextBox1.Rtf;
